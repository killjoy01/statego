...
public class Framework extends JPanel implements MouseListener, KeyListener, Runnable
{
	...
	public void init()
	{
		...
		bluepieces[1] = Toolkit.getDefaultToolkit().createImage("bluemarshal.jpg"); 
		bluepieces[2] = Toolkit.getDefaultToolkit().createImage("bluegeneral.jpg");
		bluepieces[3] = Toolkit.getDefaultToolkit().createImage("bluecolonel.jpg");
		bluepieces[4] = Toolkit.getDefaultToolkit().createImage("bluemajor.jpg");
		bluepieces[5] = Toolkit.getDefaultToolkit().createImage("bluecaptain.jpg");
		bluepieces[6] = Toolkit.getDefaultToolkit().createImage("bluelieutenant.jpg");
		bluepieces[7] = Toolkit.getDefaultToolkit().createImage("bluesergeant.jpg");
		bluepieces[8] = Toolkit.getDefaultToolkit().createImage("blueminer.jpg");
		bluepieces[9] = Toolkit.getDefaultToolkit().createImage("bluescout.jpg");
		bluepieces[10] = Toolkit.getDefaultToolkit().createImage("bluespy.jpg");
		bluepieces[11] = Toolkit.getDefaultToolkit().createImage("bluebomb.jpg");
		bluepieces[12] = Toolkit.getDefaultToolkit().createImage("blueflag.jpg");
		makeGamePieces();
		state = INIT;
	}
